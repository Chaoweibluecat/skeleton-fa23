...
public class TestOneWordK0Hyponyms {
    ...
    public static final String WORDS_FILE = "././proj2a/data/ngrams/very_short.csv";
    public static final String TOTAL_COUNTS_FILE = "././proj2a/data/ngrams/total_counts.csv";
    ...
    public void testActK0() {
        ...
        NgordnetQuery nq = new NgordnetQuery(words, 1500, 2000, 3);
